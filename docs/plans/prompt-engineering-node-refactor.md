...
- **Skill 文件化**：把 `prompts/requirement_coordinator.txt` 和 `execution.rs` 中的 inline prompt 拆成 `prompts/skills/` 下的独立文件，带 YAML frontmatter。
...
prompts/
├── skills/
│   ├── requirement_coordinator.md      # 原 requirement_coordinator.txt
